...
object CompileConfig {
    val cliExecName: String = Process.execName.substringAfterLast('.')
    val compileConfigName: String = "frconfig.json"
    val targetPath: String = Process.argv[1]
...
fun run() {
    ...
    println("execPath: ${Process.execPath}")
    println("execName: ${Process.execName}")
